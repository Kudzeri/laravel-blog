...
<head>
    ...
    <title>{{ mb_strtoupper(Auth::user()->name) }} | Profile</title><!--begin::Primary Meta Tags-->
...
<div class="app-wrapper"> <!--begin::Header-->
    ...
    <x-profile-aside></x-profile-aside>
    ...
    <footer class="app-footer"> <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Mikhail Kudze</div> <!--end::To the end--> <!--begin::Copyright--> <strong>
            Profile
        </strong>
        <!--end::Copyright-->
    </footer> <!--end::Footer-->
