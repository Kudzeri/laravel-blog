<x-admin>
    <div class="row">
        ...
        <div class="card card-primary card-outline mb-4 col-6 mx-auto"> <!--begin::Header-->
            ...
            <form action="{{route('admin.categories.store')}}" method="post"> <!--begin::Body-->
                <div class="card-body">
                    <div class="mb-3"> <label for="exampleInputPassword1" class="form-label">Name</label> <input name="name" type="text" class="form-control"> </div>
                    <div>@csrf</div>
